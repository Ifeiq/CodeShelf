...
export default function Footer1() {
    ...
    return (
        <div className="flex flex-row items-start justify-center gap-24 py-4 bg-white editable">
        ...
        <div>
            ...
            <div className="flex flex-col gap-4 mt-2">
                <div aria-label="Instagram"  className="flex flex-row gap-2 items-center hover:translate-x-2 duration-300 cursor-pointer group">
                    <Icon icon="hugeicons:pdf-01" className="text-2xl text-black group-hover:text-primary transition-colors duration-300" />
                    <p className="text-sm text-black font-bold group-hover:text-primary transition-colors duration-300 editable">PDF</p>
                </div>
