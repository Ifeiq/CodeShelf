                ...
                <div className="flex flex-row items-start gap-16">
                    ...
                    <div className=" flex flex-col gap-4">
                        ...
                        <div className="flex flex-row items-center gap-8">
                            ...
                            <button className="border-2 border-black text-black hover:scale-105 transition-all duration-300 cursor-pointer text-xs px-8 font-bold py-2 rounded-full editable cursor-pointer hover:scale-105 transition-all duration-300 ">More</button>
                        </div>
                    </div>
                </div>
            </div>  
